...
const App = () => {
  ...
  const checkIfWalletIsConnected = async () => {
    try {
      ...
      if (solana) {
        ...
        // solana object let's us connect with user's wallet
  ...
  // Render this UI when user hasn't connect wallet to app
  ...
  // Check for Phantom wallet when app is loaded
  useEffect(() => {
    const onLoad = async () => {
